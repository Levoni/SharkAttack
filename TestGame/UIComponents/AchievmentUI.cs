...
{
   [Serializable]
   public class AchievementUI : Control,  IListBoxItem
   {
      ...
      public AchievementUI(AchievmentModel achievement, EngineRectangle bounds) : base(achievement.Name, "", bounds, Color.White)
      {
         Model = achievement;
         Value = Model;
         isSelected = false;
      ...
      public void SetNewAchievement(AchievmentModel newAchievement)
      {
         AchievmentModel oldAchievement = Model;
